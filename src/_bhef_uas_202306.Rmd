...
if(!file.exists("../data/ortho/BHEF_202306_Full_RBG.tif")){
  # read list of orthos
  ...
  ######## mosaic the raster list 
    ...
    ## write the mosaic
    terra::writeRaster(ortho_rast, filename = "../data/ortho/BHEF_202306_Full_RBG.tif", overwrite = T)
  
}else{
  ortho_rast = terra::rast("../data/ortho/BHEF_202306_Full_RBG.tif")
}
  # ortho_rast %>%
  #   terra::aggregate(4) %>%
...
$$
DBH_{i} = 0 + \beta_1 \cdot Height_{i} + \beta_2 \cdot Height_{i}^{2}
$$
