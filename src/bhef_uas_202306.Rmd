...
```{r ortho-ld, results='hide', eval=FALSE}
# read list of orthos
...
field_overstory = readr::read_csv(
  ...
  sf::st_as_sf(coords = c("tree_utm_x", "tree_utm_y"), crs = sf::st_crs(treetops_sf_with_dbh), remove=F)
...
```{r fld-dta-sum-rmse, include=F, eval=F}
data.frame(
